...
"[project]/src/store/postStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const usePostStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        posts: [],
        generatedVariations: [],
        isLoading: false,
        ...
        setGeneratedVariations: (variations)=>set({
                generatedVariations: variations
            }),
        clearGeneratedVariations: ()=>set({
                generatedVariations: []
            }),
        ...
        getPostsByStatus: (status)=>get().posts.filter((post)=>post.status === status),
        getPostsByPlatform: (platform)=>get().posts.filter((post)=>post.platform === platform)
    }), {
...
"[project]/src/services/contentGenerator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateContent(options) {
    ...
    // Génère 3 variations
    const variations = platformTemplates.slice(0, 3).map((template, index)=>{
        // Remplace les placeholders par du contenu générique basé sur le prompt
        let content = template.replace(/\[Conseil principal\]/g, `Focus sur l'essentiel : ${prompt.split(' ').slice(0, 5).join(' ')}`).replace(/\[Conseil secondaire\]/g, `Priorisez la qualité`).replace(/\[Conseil bonus\]/g, `Restez cohérent`).replace(/\[Point clé \d+\]/g, (match)=>{
            const num = match.match(/\d+/)?.[0] || "1";
            return `Point important ${num} sur ${prompt.split(' ').slice(0, 3).join(' ')}`;
        }).replace(/\[Histoire personnelle liée au prompt\]/g, `Mon expérience avec ${prompt.split(' ').slice(0, 3).join(' ')} a été révélatrice`).replace(/\[Insight principal\]/g, `L'essentiel est de comprendre ${prompt.split(' ').slice(0, 3).join(' ')}`).replace(/\[Question liée au prompt\]/g, `Comment gérez-vous ${prompt.split(' ').slice(0, 3).join(' ')} ?`).replace(/\[Annonce liée au prompt\]/g, `Nouveau projet autour de ${prompt.split(' ').slice(0, 3).join(' ')}`).replace(/\[Point \d+\]/g, (match)=>{
            const num = match.match(/\d+/)?.[0] || "1";
            return `Point ${num} : ${prompt.split(' ').slice(0, 4).join(' ')}`;
        }).replace(/\[Details\]/g, `Plus d'informations à venir sur ${prompt.split(' ').slice(0, 3).join(' ')}`).replace(/\[Contexte\]/g, `Dans le contexte de ${prompt.split(' ').slice(0, 3).join(' ')}`).replace(/\[révélation\]/g, `l'importance de ${prompt.split(' ').slice(0, 2).join(' ')}`).replace(/\[transformation\]/g, `j'ai adopté une nouvelle approche`).replace(/\[leçon\]/g, `l'importance de ${prompt.split(' ').slice(0, 2).join(' ')}`).replace(/\[Conseil \d+\]/g, (match)=>{
            const num = match.match(/\d+/)?.[0] || "1";
...
"[project]/src/app/(dashboard)/dashboard/generate/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$postStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/postStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contentGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/contentGenerator.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
;
...
function GeneratePage() {
    ...
    const [selectedPlatform, setSelectedPlatform] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("linkedin");
    const [selectedType, setSelectedType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("conseil");
    ...
    const { generatedVariations, isLoading, setGeneratedVariations, clearGeneratedVariations, setLoading, addPost } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$postStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePostStore"])();
    const handleGenerate = async ()=>{
        ...
        try {
            const variations = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contentGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateContent"])({
                prompt,
    ...
    const handleSavePost = (variationId)=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Générer un post"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                        lineNumber: 98,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                        children: "Décrivez votre idée et l'IA génère du contenu authentique dans votre style"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                        lineNumber: 99,
                        columnNumber: 9
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "De quoi voulez-vous parler aujourd'hui ?"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                                        lineNumber: 109,
                                        columnNumber: 13
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Choisissez votre préférée ou régénérez"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                                        lineNumber: 179,
                                        columnNumber: 13
                                    ...
                                    children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "L'IA génère votre contenu..."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                                                lineNumber: 188,
                                                columnNumber: 19
                                        ...
                                        lineNumber: 186,
                                        columnNumber: 17
                                    }, this) : generatedVariations.length > 0 ? generatedVariations.map((variation)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg border p-4 transition-all", selectedVariation === variation.id ? "border-primary bg-primary/5" : "bg-card hover:border-primary/50"),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        selectedVariation === variation.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "mb-4 whitespace-pre-wrap text-sm leading-relaxed",
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Vos variations apparaîtront ici après génération"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(dashboard)/dashboard/generate/page.tsx",
                                            lineNumber: 243,
                                            columnNumber: 19
...
_s(GeneratePage, "a/qYwDH5KNDOFt0Wcwr1PvuSi4s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$postStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePostStore"]
    ];
});
_c = GeneratePage;
var _c;
...
//# sourceMappingURL=_0fe6f3b8._.js.map